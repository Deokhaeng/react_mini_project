...
// import { Grid, Image, Text, Box, Button } from "../elements/index";
...
// const Delete = (e) =>{
//   e.stopPropagation();
//   dispatch(deleteActions.getPostDetailDB(props.id)) 
// };

// const postApi = {
//   getPost:() => instance.get('/api/getlist')
// }

//   return (
//     <React.Fragment>
//       {/* Box:전체를 감싸는 카드박스 */}
//       <Grid margin='60px auto' _onClick={(post_id)=>{history.push(`/detail/${postApi.post_id}`)}}>
//         <Box float margin='60px'>
//         <Grid padding="3px">
//           <Text>{postApi.createdAt}</Text>
//         </Grid>
//         <Grid>
//           <Image src={postApi.image} is_contents/>
//         </Grid>
//         <Grid>
//           <Text bold="700">{postApi.title}</Text>
//           <Text>{postApi.content}</Text>
//         </Grid>
//       </Box>
//       </Grid>
...
const Post = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      <Box margin='150px 3px 3px 30px' _onClick={()=>{history.push(`/detail/${props.post_id}`)}}>
